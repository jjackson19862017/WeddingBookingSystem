...
global $style_no;
    $query = "SELECT * FROM event_details ORDER BY event_function_date ASC";
                            ...
                            echo "<td><br><span $style_hold>On Hold: $event_hold</span><br><span $style_agreement_signed>Signed: $event_agreement_signed</span><br><span $style_deposit_taken>Deposit Paid: $event_deposit_taken</span><br><span $style_25_paid>Paid: $event_25_paid</span><br><span $style_had_final_talk>Had FT: $event_had_final_talk</span></td>";
